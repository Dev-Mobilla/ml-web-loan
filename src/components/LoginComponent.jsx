          ...
          <div className="qrcode-card">
            <div className="overlap-group-5">
              ...
              <img
                ...
                src="https://anima-uploads.s3.amazonaws.com/projects/64e41d552340cba66b90f01a/releases/64e41e67e1c2a81b98b3c871/img/mlwallet-qr-code@2x.png"
              />
            </div>
          </div>
          <div className="alertinfo">
            <div className="overlap-5">
              <p className="dl-text">Download Wallet Via Qr Code Scanning</p>
              <img
                className="dl-icon"
                alt="Dl icon"
                src="https://anima-uploads.s3.amazonaws.com/projects/64e41d552340cba66b90f01a/releases/64e492714fd92dc35e55a22f/img/dl-icon-1@2x.png"
              />
            </div>
          </div>
        </div>
