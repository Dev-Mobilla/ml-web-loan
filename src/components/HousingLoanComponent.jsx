      ...
      <div className="div">
        ...
        <div className="body-bg">
          <div className="overlap">
            <div className="existing-housing">
              <div className="recentpay-card">
                <div className="recpaytxt">Recent Payments</div>
                <p className="detailsph">
                  05-14-2023&nbsp;&nbsp;&nbsp;&nbsp;16:23&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  30,625.00
                  <br />
                  <br />
              ...
              <div className="coldetails-btn">
                <div className="overlap-group">
                  <div className="coldetailstxt">Collateral Details</div>
                </div>
              </div>
              <div className="paysched-btn">
                <div className="overlap-group">
                  <div className="payschedtxt">Payment Schedule</div>
                </div>
              </div>
              <div className="paynow">
                <div className="paynow-btn">
                  <div className="overlap-group-2">
                    <div className="text-wrapper">Pay Now</div>
                    <img
                      className="paynow-icn"
                      alt="Paynow icn"
                      src="https://anima-uploads.s3.amazonaws.com/projects/64e41d552340cba66b90f01a/releases/64e41e67e1c2a81b98b3c871/img/paynow-icn@2x.png"
                    />
                  </div>
                </div>
                <p className="paynownote">
                  Please pay on or before the due
                  <br />
                  date to avoid late payment charges
                </p>
              </div>
              <div className="past-due">
                <div className="paymentdueph-wrapper">
                  <input className="paymentdueph" />
                </div>
                <div className="text-wrapper-2">Payment due by</div>
              </div>
              <div className="late-fees-charges">
                <div className="feesph-wrapper">
                  <input className="feesph" />
                </div>
                <div className="text-wrapper-2">Late fees &amp; charges</div>
              </div>
              <div className="due-month">
                <div className="dueamountph-wrapper">
                  <input className="dueamountph" />
                </div>
                <div className="text-wrapper-3">Due this month</div>
              </div>
            </div>
            <div className="h-lcurrentcard">
              <div className="overlap-2">
                <img
                  className="h-lcurrentcard-2"
                  alt="H lcurrentcard"
                ...
                />
                <div className="h-lcurrenttxt">Current</div>
              </div>
            </div>
            <div className="current-h-lrefno">Ref. no. 00000000000</div>
            <div className="current-h-ltxt">Housing Loan</div>
            <div className="hl-icon">
              <div className="overlap-3">
                ...
                <img
                  className="group"
                  alt="Group"
                  src="https://anima-uploads.s3.amazonaws.com/projects/64e41d552340cba66b90f01a/releases/64e41e67e1c2a81b98b3c871/img/group-42-1@2x.png"
                />
              </div>
            </div>
          </div>
        ...
        <header className="header">
          <div className="div-wrapper">
            <div className="text-wrapper-4">Manage Existing Loans</div>
          </div>
        </header>
